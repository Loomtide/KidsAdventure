...
{
    /// <summary>
    /// Slowly drifts a UI element horizontally and wraps it around, for the background clouds.
    /// Self-contained — Shape Match shares no FX code with CountTheFruits.
    /// </summary>
    [RequireComponent(typeof(RectTransform))]
    public class ShapeDrift : MonoBehaviour
    {
