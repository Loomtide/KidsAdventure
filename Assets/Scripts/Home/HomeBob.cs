...
{
    /// <summary>
    /// Gentle idle bob for a UI element. Sine-eases the anchoredPosition around its
    /// starting point, with optional scale breathing. Self-contained home-screen FX.
    /// </summary>
    [RequireComponent(typeof(RectTransform))]
    public class HomeBob : MonoBehaviour
    {
